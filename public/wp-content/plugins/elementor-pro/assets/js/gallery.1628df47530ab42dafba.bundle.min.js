            ...
            class galleryHandler extends elementorModules.frontend.handlers.Base {
                ...
                getGallerySettings() {
                    const e = this.getElementSettings(),
                        ...
                        n = Object.keys(t),
                        i = {},
                        a = elementorFrontend.getDeviceSetting("desktop", e, "ideal_row_height");
                    return n.forEach((n => {
                        if ("widescreen" !== n) {
                            const a = elementorFrontend.getDeviceSetting(n, e, "ideal_row_height");
                            i[t[n].value] = {
                ...
                onElementChange(e) {
                    if (this.getGallerySettings(), -1 !== ["background_overlay_hover_animation", "content_hover_animation", "image_hover_animation", "content_sequenced_animation"].indexOf(e)) return void this.toggleAnimationClasses(e);
