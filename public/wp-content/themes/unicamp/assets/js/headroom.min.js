! function(t, o) {
    ...
    function r(t) {
        ...
        for (var o, i, n = t || {}, e = 1; e < arguments.length; e++) {
            var s = arguments[e] || {};
            for (o in s) "object" != typeof n[o] || (i = n[o]) && "undefined" != typeof window && (i === window || i.nodeType) ? n[o] = n[o] || s[o] : n[o] = r(n[o], s[o])
        }
        return n
    }

    function i(t, o) {
        o = r(o, i.options), this.lastKnownScrollY = 0, this.elem = t, this.tolerance = (t = o.tolerance) === Object(t) ? t : {
            down: t,
            up: t
    ...
    return window.requestAnimationFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame, o.prototype = {
        ...
        update: function() {
            var t = this.getScrollY(),
                ...
                o = this.toleranceExceeded(t, o);
            this.isOutOfBounds(t) || (t <= this.offset ? this.top() : this.notTop(), t + this.getViewportHeight() >= this.getScrollerHeight() ? this.bottom() : this.notBottom(), this.shouldUnpin(t, o) ? this.unpin() : this.shouldPin(t, o) && this.pin(), this.lastKnownScrollY = t)
        }
    }, i.options = {
        tolerance: {
            up: 0,
...
function(e) {
    e && (e.fn.headroom = function(n) {
        return this.each(function() {
            var t = e(this),
                o = t.data("headroom"),
                i = "object" == typeof n && n,
                i = e.extend(!0, {}, Headroom.options, i);
            o || ((o = new Headroom(this, i)).init(), t.data("headroom", o)), "string" == typeof n && (o[n](), "destroy" === n) && t.removeData("headroom")
        })
