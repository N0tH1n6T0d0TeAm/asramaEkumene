...
<title>Kegiatan Bersama - Tipar Cakung</title>
...
<div class="sty_pengurus">
   ...
   @foreach($data->where('status', 'Pengurus Asrama')->where('asrama', 'TC (Tipar Cakung)') as $d)
  <div class="card">
...
@endphp
     ...
     <div class="stt_ekumene_post">
         @foreach($data3->where('posisi_asrama', 'TC (Tipar Cakung)') as $d)
        <div class="kartu">
            <b>{{$d->posisi_asrama}}</b>
