<div>
    <title>Kegiatan Dikeseluruhan Asrama</title>
...
<div class="sty_pengurus">
    ...
    @foreach($data->where('status', 'Pengurus Asrama') as $d)
  <div class="card">
...
@endphp
    ...
    <div class="stt_ekumene_post">
        @foreach($data3->where('posisi_asrama', 'Semua') as $d)
        <div class="kartu">
            <b>STT Ekumene (Plumpang, Tipar Cakung, Kirana)</b>
            ...
            @foreach($data2->where('id_kegiatan', $d->id) as $ds)
